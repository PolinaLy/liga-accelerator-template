...
var _initAccordion = require("./accordion/init-accordion");
// ---------------------------------
...
},{"./accordion/init-accordion":2,"./modules/form-validate/form":5,"./modules/swiper":11,"./modules/tabs/init-tabs":12,"./modules/video":14,"./utils/ios-vh-fix":16}],4:[function(require,module,exports){
"use strict";
...
var initSwiper = function initSwiper() {
  ...
  var swiperSlideInfo = document.querySelectorAll('.swiper-slide__info');
  if (mediaQuery.matches) {
    swiperSlideInfo.forEach(function (el) {
