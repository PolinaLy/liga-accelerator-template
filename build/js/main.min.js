...
require("./modules/tabs/index");
require("./modules/tabs/init-tabs");
require("./modules/tabs/tabs");
require("./modules/accordion/accordions");
require("./modules/accordion/index");
require("./modules/accordion/init-accordion");
require("./modules/scroll-link");
// ---------------------------------
...
},{"./modules/accordion/accordions":2,"./modules/accordion/index":3,"./modules/accordion/init-accordion":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/scroll-link":14,"./modules/tabs/index":15,"./modules/tabs/init-tabs":16,"./modules/tabs/tabs":17,"./modules/video":18,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";
...
},{"./init-accordion":4}],4:[function(require,module,exports){
"use strict";
...
},{"./accordions":2}],5:[function(require,module,exports){
"use strict";
...
var _initTabs = require("./init-tabs");
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
...
},{"./init-tabs":16}],16:[function(require,module,exports){
"use strict";
...
var buttonPlay = document.querySelector('.gym__video-button');
